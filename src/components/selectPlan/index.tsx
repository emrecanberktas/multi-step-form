  ...
  return (
    <div className="Select-Plan">
      <div className="Select-Plan-Description">
        <p className="Select-Plan-Title">Select your plan</p>
        <p className="Select-Plan-Subtitle">
          Choose the plan that best fits your needs.
        </p>
      </div>
      <div className="Select-Plan-Options">
        <div className="Select-Plan-Option">
          <div className="Select-Plan-Option-Image">
            <svg
          ...
          <div className="Select-Plan-Option-Desc">
            <p className="Select-Plan-Option-Title">Arcade</p>
            <p>$9/mo</p>
          </div>
        </div>
        <div className="Select-Plan-Option">
          ...
          <div className="Select-Plan-Option-Desc">
            <p className="Select-Plan-Option-Title">Advanced</p>
            <p>$9/mo</p>
          </div>
        </div>
        <div className="Select-Plan-Option">
          ...
          <div className="Select-Plan-Option-Desc">
            <p className="Select-Plan-Option-Title">Pro</p>
            <p>$9/mo</p>
          </div>
        </div>
      </div>
      <div className="Select-Plan-Option-Switch">
        <Switch {...label} />
      </div>
